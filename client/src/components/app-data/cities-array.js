...
const citiesArray = [
    {id: 1, label: 'Tel-Aviv', name: 'tel_aviv', description: 'Wonderful city', country: 'Israel', image: "images/cities/_tel_aviv.jpg"},
    {id: 2, label: 'New-York', name: 'new_york', description: 'Wonderful city', country: 'United State', image: "images/cities/_new_york.jpg"},
    {id: 3, label: 'New-Delhi', name: 'new_delhi', description: 'Wonderful city', country: 'United State', image: "images/cities/new_delhi.jpg"},
    ...
    {id: 9, label: 'Bacău', name: 'bacău', description: 'Wonderful city', country: 'Romania', image: "images/cities/bacau.jpg"},
    ...
    {id: 12, label: 'Rio-de-Janeiro', name: 'rio_de_janeiro', description: 'Wonderful city', country: 'Brazil', image: "images/cities/rio_de_janeiro.jpg"},
